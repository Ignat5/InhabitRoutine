...
import com.ignatlegostaev.inhabitroutine.feature.create_edit_task.create.config.ConfirmLeavingDialog
    ...
    TopAppBar(
        ...
        navigationIcon = {
            IconButton(onClick = onCloseClick) {
                Icon(
                    painter = painterResource(id = com.ignatlegostaev.inhabitroutine.core.presentation.R.drawable.ic_close),
        ...
        actions = {
            TextButton(
                ...
                Text(text = stringResource(id = com.ignatlegostaev.inhabitroutine.core.presentation.R.string.save))
            }
        }
    )
}