...
import com.ignatlegostaev.inhabitroutine.core.presentation.ui.common.BaseOutlinedTextField
...
private fun PickTaskNumberProgressDialogStateless(
    ...
    BaseDialog(
        ...
        title = {
            BaseDialogDefaults.BaseDialogTitle(titleText = stringResource(id = com.ignatlegostaev.inhabitroutine.core.presentation.R.string.task_config_progress))
        },
        ...
        Column(
            ...
            BaseOutlinedTextField(
                ...
                modifier = Modifier.fillMaxWidth(),
                label = {
                    Text(text = stringResource(id = com.ignatlegostaev.inhabitroutine.core.presentation.R.string.task_config_limit_number_label))
                },
                singleLine = true,
            ...
            Row(
                ...
                BaseOutlinedTextField(
                    ...
                    label = {
                        Text(text = stringResource(id = com.ignatlegostaev.inhabitroutine.core.presentation.R.string.task_config_limit_unit_label))
                    },
                    keyboardActions = KeyboardActions {
                ...
                Text(
                    text = stringResource(id = com.ignatlegostaev.inhabitroutine.core.presentation.R.string.daily_goal_suffix),
