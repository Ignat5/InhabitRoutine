...
import com.ignatlegostaev.inhabitroutine.MainActivity
...
import com.ignatlegostaev.inhabitroutine.domain.model.util.checkIfCanSetReminderForDate
import com.ignatlegostaev.inhabitroutine.platform.reminder.util.ReminderUtil
    ...
    private fun showNotificationReminder(
        ...
        createNotificationReminderChannel(context).let { channel ->
            ...
            NotificationCompat.Builder(context, channel.id)
                .setSmallIcon(com.ignatlegostaev.inhabitroutine.R.drawable.ic_app_notification)
